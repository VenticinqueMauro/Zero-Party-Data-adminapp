...
const SurveyList: FC<Props> = ({ runtime }) => {
  ...
  const handleViewResponses = (id: string) => {
    runtime.navigate({ page: 'admin.app.zpd-surveys-responses', params: { id } })
  }
      ...
      <div style={card}>
        ...
        <div style={cardInfoLeft}>
          ...
          <div style={cardMeta}>
            ...
            <span style={badge}><strong>{survey.responseCount}</strong> respuestas</span>
        ...
        <div style={cardActionsRight}>
          <div
            ...
            onKeyDown={(e) => e.key === 'Enter' && handleViewResponses(survey.id)}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 12H2V1C2 0.4 1.6 0 1 0C0.4 0 0 0.4 0 1V13C0 13.6 0.4 14 1 14H15C15.6 14 16 13.6 16 13C16 12.4 15.6 12 15 12Z" fill="silver" />
              <path d="M4.7 9.7C5.1 10.1 5.7 10.1 6.1 9.7L8 7.8L10.3 10.1C10.7 10.5 11.3 10.5 11.7 10.1L15.7 6.1C16.1 5.7 16.1 5.1 15.7 4.7C15.3 4.3 14.7 4.3 14.3 4.7L11 8L8.7 5.7C8.3 5.3 7.7 5.3 7.3 5.7L4.7 8.3C4.3 8.7 4.3 9.3 4.7 9.7Z" fill="silver" />
            </svg>
          </div>
          <div
            role="button"
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.7 0.3C11.3 -0.1 10.7 -0.1 10.3 0.3L0.3 10.3C0.1 10.5 0 10.7 0 11V15C0 15.6 0.4 16 1 16H5C5.3 16 5.5 15.9 5.7 15.7L15.7 5.7C16.1 5.3 16.1 4.7 15.7 4.3L11.7 0.3ZM4.6 14H2V11.4L8 5.4L10.6 8L4.6 14ZM12 6.6L9.4 4L11 2.4L13.6 5L12 6.6Z" fill="silver" />
            </svg>
          </div>
          <div
            role="button"
            ...
            onKeyDown={(e) => e.key === 'Enter' && !survey.isActive && handleDeleteClick(survey.id)}
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M13 3H10V2C10 0.9 9.1 0 8 0C6.9 0 6 0.9 6 2V3H3C2.4 3 2 3.4 2 4C2 4.6 2.4 5 3 5H3.1L3.9 14.1C4 15.2 4.9 16 6 16H10C11.1 16 12 15.2 12.1 14.1L12.9 5H13C13.6 5 14 4.6 14 4C14 3.4 13.6 3 13 3ZM8 2C8.6 2 8 2.4 8 3H8C8 2.4 7.4 2 8 2ZM10.1 14H5.9L5.1 5H10.9L10.1 14Z" fill="#ff4c4c" />
            </svg>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
        ...
        {surveys.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '16px' }}>
            ...
            {filteredSurveys.length === 0 ? (
              <div style={{ textAlign: 'center' as const, padding: '32px 0', color: '#979899', fontSize: '14px' }}>
      ...
      >
        <p>¿Estás seguro de que quieres eliminar esta encuesta? Se eliminarán también todas las respuestas asociadas.</p>
      </Modal>
    </Layout>
  )
}
